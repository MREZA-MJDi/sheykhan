...
<head>
    ...
    <meta
        name="description"
        content="@yield('description', 'پنل دانش‌آموز فرزین')"
    >
...
>
    ...
    <div class="min-h-screen lg:pr-[var(--sidebar-width)]">
        ...
        {{-- Topbar --}}
        <header class="sticky top-0 z-[var(--z-sticky)] border-b border-[var(--color-border)] bg-white/95 backdrop-blur">
