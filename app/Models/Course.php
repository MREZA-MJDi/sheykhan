...
class Course extends Model {
 ...
 public function teachers(): BelongsToMany{return $this->belongsToMany(User::class,'course_teacher','course_id','teacher_id')->withPivot('is_primary')->withTimestamps();}
 ...
 public function isFree(): bool{return $this->access_type==='free';}
 public function requiresPayment(): bool{return $this->access_type==='paid';}
}